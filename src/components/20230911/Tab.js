      ...
      <div className="about-center section-center">
        ...
        <article className="about">
          ...
          <div className="btn-container">
            <button className="tab-btn active" id="history">history</button>
            <button className="tab-btn" id="vision">vision</button>
            <button className="tab-btn" id="goals">goals</button>
          </div>
